...
const CATALOGUE = {
  ...
  "products": [
    ...
    },
    {
      ...
      "blurb": "Any five instruments administered within a one-year period, with up to 10 institution-specific questions per survey. Raw data, a norms-comparison report for each of the five, a predictive model per survey (with more than 300 responses) and interactive dashboards. Plus a one-hour webinar with Dr. Schreiner: results, recommended actions and national trends, synthesized across all five surveys with a thematic analysis of comments. Unlimited stakeholders, recordable."
    },
    {
      "key": "addon-questions",
